...
def run_kg_pipeline(
    ...
    collection_name: str = "interviewtutor",
    ...
    Args:
        ...
        collection_name: ChromaDB集合名称（默认："interviewtutor"）
...
def build_knowledge_graph(
    ...
    try:
        # 尝试导入知识图谱构建器
        from app.knowledge_graph.kg_builder import build_knowledge_graph_from_pdf
    except ImportError as e:
        log(f"缺少知识图谱构建模块: {e}")
