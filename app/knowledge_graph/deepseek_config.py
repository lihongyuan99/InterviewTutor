...
from app.knowledge_graph.deepseek_config import extract_entities_with_llm

text = "机器学习是人工智能的一个分支..."
result = extract_entities_with_llm(text, model="deepseek-chat")

# 使用 DeepSeek LLM 推断关系
from app.knowledge_graph.deepseek_config import infer_relations_with_llm

entities = [{"text": "机器学习", "type": "TECH"}, {"text": "人工智能", "type": "TECH"}]
relations = infer_relations_with_llm(entities, text)

# 使用 DeepSeek LLM 归一化实体
from app.knowledge_graph.deepseek_config import normalize_entities_with_llm
