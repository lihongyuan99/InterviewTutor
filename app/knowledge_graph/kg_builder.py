...
try:
    from app.knowledge_graph.kg_extractor import KGEntityExtractor
...
try:
    from app.knowledge_graph.deepseek_extractor import DeepSeekKGExtractor
...
class KnowledgeGraphBuilder:
    ...
    def build_graph(self, text: str) -> Dict[str, Any]:
        ...
        if any([self.enable_semantic_normalization, self.enable_transitive_reduction,
            ...
            try:
                from app.knowledge_graph.kg_optimizer import KnowledgeGraphOptimizer
